...
class REG {
    ...
    public REG(String nom, int d, int m, int an, int telef) {
...
public class listaDupla {
    ...
    public int preencherLista(listaDupla List) {
        ...
        try {
            ...
            if(tipo == 1){
                try {
                    ...
                    int ano;
                    int telefone;
                    System.out.print("Qual o numero de registos no ficheiro? ");
    ...
    public void ColocaElementoEsqLista(String n, int d, int m, int a, int t) {
    ...
    public void ColocaElementoDirLista(String n, int d, int m, int a, int t) {
    ...
    public boolean deltaData(int ano, int mes, int dia){
        boolean maior=false;
